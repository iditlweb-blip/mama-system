...
export interface StandardTest {
  ...
  coverage: string      // Israeli sal briut / kupat cholim coverage note - see COVERAGE_DISCLAIMER
}

// General-information note about coverage/cost figures below - not a price
// commitment, and NOT test-specific advice. Show this alongside any
// `coverage` text in the UI.
export const COVERAGE_DISCLAIMER =
  'מידע כללי בלבד ולא מהווה התחייבות למחיר או לכיסוי - התנאים משתנים לפי קופת חולים, מסלול ביטוח וזמן. מבוסס על מידע פומבי מאתרי קופות החולים, כדאי לוודא מול הקופה שלך.'
...
export const STANDARD_TESTS: StandardTest[] = [
  { week: 6,  until: 10, name: 'בדיקות דם ראשונות',
    ...
    coverage: 'כלולה במלואה בסל הבריאות, ללא עלות.' },
  { week: 10, until: 13, name: 'בדיקת שקיפות עורפית',
    ...
    coverage: 'כלולה בסל הבריאות. במכוני הסדר ייתכנו תור ארוך יותר או השתתפות עצמית קטנה.' },
  { week: 11, until: 13, name: 'בדיקת סיסי שליה',
    ...
    coverage: 'לא כלולה באופן גורף בסל הבריאות - בעלות ביטוח משלים לרוב יש השתתפות עצמית של כמה מאות שקלים; ללא ביטוח משלים העלות המלאה גבוהה יותר.' },
  ...
  { week: 16, until: 20, name: 'בדיקת מי שפיר',
    ...
    coverage: 'לא כלולה באופן גורף בסל הבריאות - בעלות ביטוח משלים ההשתתפות העצמית נעה בדרך כלל בין כמה עשרות למאות שקלים לפי מסלול; ללא ביטוח משלים העלות המלאה גבוהה משמעותית.' },
  { week: 19, until: 24, name: 'סקירת מערכות מפורטת',
    ...
    coverage: 'כלולה בסל הבריאות, מבוצעת במכון הסדר של הקופה.' },
  ...
  { week: 28, until: 30, name: 'בדיקת דם ונוגדנים',
    ...
    coverage: 'כלולה במלואה בסל הבריאות, כולל הזריקה למי שצריכה אותה, ללא עלות.' },
  { week: 32, until: 34, name: 'אקו גדילה',
    explanation: 'בדיקת אולטרסאונד שבודקת שהעובר גדל בקצב תקין, כמה מי שפיר יש, ואיפה השליה נמצאת.',
    coverage: 'כלולה בסל הבריאות כמעקב שגרתי; בדיקות אקו נוספות מעבר לנדרש רפואית עשויות להיות בתשלום.' },
...
// Additional tests not everyone chooses to do - offered alongside the
// standard schedule above but not part of it (no week/reminder fields,
...
export const ADDITIONAL_TESTS: AdditionalTest[] = [
  { name: 'בדיקת NIPT (דנ"א עוברי)',
    explanation: 'בדיקת דם מדויקת מאוד לסיכון לתסמונות כרומוזומליות (כמו דאון), מתבצעת מהיריון מוקדם. לא כל אישה עושה אותה - זו בדיקה נוספת, לא תחליף לשקיפות העורפית והסקר המשולב שכן כלולים בסל.',
    coverage: 'לא כלולה בסל הבריאות הבסיסי. עלות פרטית מלאה נעה בדרך כלל בין כ-3,000 ל-6,000 ש"ח. עם ביטוח משלים (ולעיתים אחרי תקופת אכשרה) חלק מהקופות מציעות החזר חלקי - למשל עד כ-2,000-4,000 ש"ח או אחוז מסוים מההוצאה, בהתאם למסלול הביטוח ולתנאי הזכאות.' },
]
