...
import AskQuestionForm from '@/app/community/AskQuestionForm'
...
// The community's content, shared between the public website (/community) and
// the in-app mirror (/content/community) - same data, same rendering, just
// wrapped by a different shell. `basePath` keeps question links pointing at
// whichever surface the reader is currently on.
export default async function CommunityFeed({ basePath }: { basePath: string }) {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 34 }}>
        <AskQuestionForm isLoggedIn={!!user} basePath={basePath} />
      </div>
