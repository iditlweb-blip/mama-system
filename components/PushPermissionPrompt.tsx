    ...
    <div style={{
      ...
      <div dir="rtl" style={{
        ...
        <p style={{ margin: '0 0 18px', fontSize: '0.85rem', color: 'var(--text-muted, #8a7680)', lineHeight: 1.6 }}>
          נשלח לך התראה על משימות שקבעת, בדיקות הריון שעומדות להסתיים, ותנומה שנמשכת הרבה זמן - גם כשהאפליקציה סגורה. תמיד אפשר לבחור בדיוק אילו התראות להפעיל מתוך ההגדרות.
        </p>
